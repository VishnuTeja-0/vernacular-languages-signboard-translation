...
\title{Signboard Translaton from Indian Vernacular Languages} % Enter The Project Title

\firstauthor{ Vishnu Teja Chikkala }% Enter The Student name
\firstauthorregno{[Reg No: RA1711003030378]}
\secondauthor{ Rajpreet Srivastav}% Enter The Student name
\secondauthorregno{[Reg No: RA1711003030383]}
...
\fifthauthor{}
\fifthauthorregno{}
\guide{Mr. Sunil Kumar} % Enter your guide's name
...
\acro{LSTM}{Long Short-Tem Memory}
